...
HD_PWD='C:/Users/thony/OneDrive/Escritorio/Maestria/CLP/codigos/practica2/Sintesis/practica2/practica2.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log uart_top_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_top_VIO.tcl
