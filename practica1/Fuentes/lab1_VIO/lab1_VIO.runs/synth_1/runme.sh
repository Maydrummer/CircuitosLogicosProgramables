...
HD_PWD='C:/Users/thony/OneDrive/Escritorio/Maestria/CLP/codigos/practica1/Fuentes/lab1_VIO/lab1_VIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab1_VIO.tcl
