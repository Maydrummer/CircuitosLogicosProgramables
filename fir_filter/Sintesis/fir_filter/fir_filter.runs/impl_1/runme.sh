...
HD_PWD='C:/Users/thony/OneDrive/Escritorio/Maestria/CLP/codigos/fir_filter/Sintesis/fir_filter/fir_filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_VIO_ILA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fir_filter_VIO_ILA.tcl -notrace
