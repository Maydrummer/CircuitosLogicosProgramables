...
HD_PWD='C:/Users/thony/OneDrive/Escritorio/Maestria/CLP/codigos/fir_filter/Sintesis/fir_filter/fir_filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_filter_VIO_ILA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_filter_VIO_ILA.tcl
